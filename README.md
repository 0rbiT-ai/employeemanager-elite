...
TEAMS_TENANT_ID = your_ms_teams_tenant_id_guid\
TEAMS_CLIENT_ID = your_ms_teams_client_id_guid\
TEAMS_CLIENT_SECRET = your_ms_teams_client_secret_string
...
| :--- | :--- | :--- | :--- |
| **`ADMIN`** | Admin | `USER_VIEW`, `USER_CREATE`, `USER_UPDATE`, `USER_DELETE`, `EMPLOYEE_VIEW`, `EMPLOYEE_CREATE`, `EMPLOYEE_UPDATE`, `EMPLOYEE_DELETE`, `TEAM_VIEW`, `TEAM_CREATE`, `TEAM_UPDATE`, `TEAM_DELETE`, `PROJECT_VIEW`, `PROJECT_CREATE`, `PROJECT_UPDATE`, `PROJECT_DELETE`, `TASK_VIEW`, `TASK_CREATE`, `TASK_UPDATE`, `TASK_DELETE`, `TIMESHEET_VIEW`, `TIMESHEET_CREATE`, `TIMESHEET_UPDATE`, `TIMESHEET_DELETE`, `ATTACHMENT_VIEW`, `ATTACHMENT_UPLOAD`, `ATTACHMENT_DELETE`, `ANNOUNCEMENT_VIEW`, `ANNOUNCEMENT_CREATE`, `ANNOUNCEMENT_UPDATE`, `ANNOUNCEMENT_DELETE`, `TEAMS_POST`, `MEETING_VIEW`, `MEETING_CREATE`, `MEETING_UPDATE`, `MEETING_DELETE`, `LINK_VIEW`, `LINK_CREATE`, `LINK_UPDATE`, `LINK_DELETE` | **All Endpoints** (Authentication, Employees, Teams, Projects, Tasks, Comments, Progress, Tags, Attachments, ETA requests, Task transfers, Timesheets, Meetings, Links) |
| **`TEAM_LEAD`** | Team Lead | `EMPLOYEE_VIEW`, `TEAM_VIEW`, `TEAM_CREATE`, `TEAM_UPDATE`, `TEAM_DELETE`, `PROJECT_VIEW`, `PROJECT_CREATE`, `PROJECT_UPDATE`, `PROJECT_DELETE`, `TASK_VIEW`, `TASK_CREATE`, `TASK_UPDATE`, `TASK_DELETE`, `TIMESHEET_VIEW`, `TIMESHEET_CREATE`, `TIMESHEET_UPDATE`, `TIMESHEET_DELETE`, `ATTACHMENT_VIEW`, `ATTACHMENT_UPLOAD`, `ATTACHMENT_DELETE`, `ANNOUNCEMENT_VIEW`, `ANNOUNCEMENT_CREATE`, `ANNOUNCEMENT_UPDATE`, `ANNOUNCEMENT_DELETE`, `TEAMS_POST`, `MEETING_VIEW`, `MEETING_CREATE`, `MEETING_UPDATE`, `MEETING_DELETE`, `LINK_VIEW`, `LINK_CREATE`, `LINK_UPDATE`, `LINK_DELETE` | Authentication, Teams, Projects, Tasks, Comments, Progress, Tags, Attachments, ETA requests, Task transfers, Timesheets, Meetings, Links (No Employee CRUD except View) |
| **`SUB_LEAD`** | Sub Lead | `EMPLOYEE_VIEW`, `TEAM_VIEW`, `TEAM_CREATE`, `TEAM_UPDATE`, `TEAM_DELETE`, `PROJECT_VIEW`, `PROJECT_CREATE`, `PROJECT_UPDATE`, `PROJECT_DELETE`, `TASK_VIEW`, `TASK_CREATE`, `TASK_UPDATE`, `TASK_DELETE`, `TIMESHEET_VIEW`, `TIMESHEET_CREATE`, `TIMESHEET_UPDATE`, `TIMESHEET_DELETE`, `ATTACHMENT_VIEW`, `ATTACHMENT_UPLOAD`, `ATTACHMENT_DELETE`, `ANNOUNCEMENT_VIEW`, `ANNOUNCEMENT_CREATE`, `ANNOUNCEMENT_UPDATE`, `ANNOUNCEMENT_DELETE`, `TEAMS_POST`, `MEETING_VIEW`, `MEETING_CREATE`, `MEETING_UPDATE`, `MEETING_DELETE`, `LINK_VIEW`, `LINK_CREATE`, `LINK_UPDATE`, `LINK_DELETE` | Authentication, Teams, Projects, Tasks, Comments, Progress, Tags, Attachments, ETA requests, Task transfers, Timesheets, Meetings, Links (No Employee CRUD except View) |
| **`EMPLOYEE`** | Employee | `EMPLOYEE_VIEW`, `TEAM_VIEW`, `PROJECT_VIEW`, `TASK_VIEW`, `TASK_UPDATE`, `TIMESHEET_VIEW`, `TIMESHEET_CREATE`, `TIMESHEET_DELETE`, `ATTACHMENT_VIEW`, `ATTACHMENT_UPLOAD`, `ATTACHMENT_DELETE`, `ANNOUNCEMENT_VIEW`, `TEAMS_POST`, `MEETING_VIEW`, `MEETING_CREATE`, `MEETING_UPDATE`, `MEETING_DELETE`, `LINK_VIEW`, `LINK_CREATE`, `LINK_UPDATE`, `LINK_DELETE` | Authentication, Tasks, Comments, Progress, Attachments, Timesheets, Meetings, Links |
...
### 20.1. Get Microsoft Teams (Groups)
*   **HTTP Method:** `GET`
*   **Path:** `/groups`
*   **Required Permission:** `TEAM_CREATE`
*   **Success Response (200 OK):** Returns a list of available Microsoft Teams (Office 365 Groups with the `Team` resource provisioning option):
    ```json
    [
      {
...
### 20.2. Get Channels for Microsoft Team
*   **HTTP Method:** `GET`
*   **Path:** `/groups/{groupId}/channels`
*   **Required Permission:** `TEAM_CREATE`
*   **Path Parameters:**
    *   `groupId` (String, Required): Microsoft Group GUID.
*   **Success Response (200 OK):** Returns a list of channels configured for the selected Team:
    ```json
    [
      {
...
## 21. Membership Behavior & Access Rules Matrix
...
| **Get MS Teams List** | Allowed | Allowed | Blocked (403) | Blocked (403) | Requires `TEAM_CREATE` permission |
| **Get MS Channels List** | Allowed | Allowed | Blocked (403) | Blocked (403) | Requires `TEAM_CREATE` permission |
| **View Another Employee's Teams** | Allowed | Blocked (403) | Blocked (403) | Blocked (403) | |
| **View Own Teams** | Allowed | Allowed | Allowed | Allowed | |

### 21.2. Projects & Project Management Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.5. Task Comments Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.6. Task Tags & Tag Mapping Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.7. Task Attachments Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.8. ETA Extension Requests Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.9. Task Transfer Requests Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.10. Task Status History Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.11. Timesheet Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.12. Attachment Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.13. Feed & Teams Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.14. Meetings Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.16. Task Draft Batch & Teams Notification Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
### 21.17. MS Teams Graph Integration Module Behavior
| Action | Admin | Team Lead | Sub Lead | Employee | Notes |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Get Microsoft Teams List** | Allowed | Allowed | Allowed | Blocked (403) | Requires `TEAM_CREATE` permission |
| **Get Microsoft Channels List** | Allowed | Allowed | Allowed | Blocked (403) | Requires `TEAM_CREATE` permission |
