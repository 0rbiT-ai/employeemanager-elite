...
public class DatabaseIndexInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 1. Create partial unique indexes (only unique for active/non-deleted records)
        ...
        //task draft status
        jdbcTemplate.execute("CREATE UNIQUE INDEX IF NOT EXISTS idx_task_draft_open ON task_draft_batch(created_by) WHERE status = 'OPEN';");
